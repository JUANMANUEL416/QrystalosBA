      ...
      ORDER BY N_CUOTA ASC
	   ...
	   BEGIN 
         SELECT @ITEM=CONVERT(varchar(3),N_CUOTA),@CANTIDAD=CONVERT(varchar(4),CONVERT(INT,CEILING(FTRD.CANTIDAD))),
                ...
                @VALOR2=CONVERT(VARCHAR(20),CONVERT(DECIMAL(14,4),COALESCE(VALOR,0)+COALESCE(VIVA,0)/COALESCE(FTRD.CANTIDAD,0))),
                ...
                @VALOR7=CONVERT(VARCHAR(20),CONVERT(DECIMAL(14,3),ROUND(((COALESCE(VALOR,0))*COALESCE(FTRD.CANTIDAD,0))-CASE WHEN COALESCE(FTRD.VLR_COPAGOS,0)>0 THEN FTRD.VLR_COPAGOS ELSE 0 END+CASE WHEN COALESCE(PIVA,0)> 0 THEN COALESCE(VIVA,0) ELSE 0 END,2))),
