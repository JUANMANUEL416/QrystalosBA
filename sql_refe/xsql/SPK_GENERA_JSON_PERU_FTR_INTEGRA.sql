...
BEGIN  
   ...
   BEGIN
      ...
      BEGIN
         SELECT @OBSERVACION=AFI.TIPO_DOC+': '+REPLACE(REPLACE(LTRIM(RTRIM(AFI.DOCIDAFILIADO)),CHAR(10),''),CHAR(13),'')+' NOMBRE: '+REPLACE(REPLACE(LTRIM(RTRIM(AFI.NOMBREAFI)),CHAR(10),''),CHAR(13),'')+' '+@OBSERVACION
