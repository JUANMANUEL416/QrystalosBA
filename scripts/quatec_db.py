#!/usr/bin/env python3
"""Mini base de datos SQLite — Qrys.Quatec (casos, chat, histórico, cola)."""
...
DB_PATH = os.path.join(DATA_DIR, "quatec.db")
...
class QuatecDB:
    def __init__(self, root: str | None = None):
        ...
        self.db_path = os.path.join(self.root, "data", "quatec.db")
