...
1. `activo/20260829-0100016165/solicitud.json` — formulario completo
2. `activo/20260829-0100016165/chat.json` — mensajes del coordinador (releer en cada turno)
3. `C:\DevQuasar\Qrystalos\QrystalosBA\cola\aval-asesor-lista.htm` — HTML avalasesor (cola)
4. `sql/` — scripts: SPQ_FNOT_COL.sql
...
## Caso
- **ID caso:** 20260829-0100016165
- **ID REQ:** 0100016165
- **Dictamen:** dictamenes/20260829-0100016165.html

## Fase 1 — su tarea ahora
1. Analizar requerimiento + SQL + código Qrystalos2 + documentación.
2. Generar **propuesta** en `dictamenes/20260829-0100016165.html`.
3. Resumir propuesta en `activo/20260829-0100016165/chat.json` (autor: agente) o indicar al coordinador que abra el dictamen.
