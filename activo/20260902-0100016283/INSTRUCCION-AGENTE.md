...
1. `activo/20260902-0100016283/solicitud.json` — formulario completo
2. `activo/20260902-0100016283/chat.json` — mensajes del coordinador (releer en cada turno)
...
- SPQ_FGLO_COL · TRAE_MOTIGLO (estado: leido)
   ...
   - En el **Chat del caso** (`activo/20260902-0100016283/chat.json`), en el primer resumen, indique si hace falta el .sql de hoy:
...
## Caso
- **ID caso:** 20260902-0100016283
- **ID REQ:** 0100016283
- **Dictamen:** dictamenes/20260902-0100016283.html

## Fase 1 — su tarea ahora
1. Analizar requerimiento + (fichas SP en conocimiento/ y/o SQL de hoy) + código Qrystalos2 + documentación.
2. Generar **propuesta** en `dictamenes/20260902-0100016283.html`.
3. Resumir propuesta en `activo/20260902-0100016283/chat.json` (autor: agente) o indicar al coordinador que abra el dictamen.
