...
1. `activo/20260903-0100016305/solicitud.json` — formulario completo
2. `activo/20260903-0100016305/chat.json` — mensajes del coordinador (releer en cada turno)
3. `C:\DevQuasar\Qrystalos\Qrys.Quatec\cola\IX OnLine.htm` — HTML avalasesor (cola)
4. `sql/` — scripts: no se requiere sql
...
## Caso
- **ID caso:** 20260903-0100016305
- **ID REQ:** 0100016305
- **Dictamen:** dictamenes/20260903-0100016305.html

## Fase 1 — su tarea ahora
1. Analizar requerimiento + (fichas SP en conocimiento/ y/o SQL de hoy) + código Qrystalos2 + documentación.
2. Generar **propuesta** en `dictamenes/20260903-0100016305.html`.
3. Resumir propuesta en `activo/20260903-0100016305/chat.json` (autor: agente) o indicar al coordinador que abra el dictamen.
