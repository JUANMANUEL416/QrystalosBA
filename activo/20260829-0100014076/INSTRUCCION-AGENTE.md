...
1. `activo/20260829-0100014076/solicitud.json` — formulario completo
2. `activo/20260829-0100014076/chat.json` — mensajes del coordinador (releer en cada turno)
...
## Caso
- **ID caso:** 20260829-0100014076
- **ID REQ:** 0100014076
- **Dictamen:** dictamenes/20260829-0100014076.html

## Fase 1 — su tarea ahora
1. Analizar requerimiento + SQL + código Qrystalos2 + documentación.
2. Generar **propuesta** en `dictamenes/20260829-0100014076.html`.
3. Resumir propuesta en `activo/20260829-0100014076/chat.json` (autor: agente) o indicar al coordinador que abra el dictamen.
